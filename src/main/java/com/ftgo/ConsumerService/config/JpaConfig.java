...
@EnableJpaRepositories(basePackages = "com.ftgo.ConsumerService.domain.consumer.repository")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        factory.setPackagesToScan("com.ftgo.ConsumerService.domain.consumer.entity");
